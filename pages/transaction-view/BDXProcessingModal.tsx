...
import { WorkbenchLogo } from '@design-library/icons';
...
BDXAnimation.displayName = 'BDXAnimation';

/**
 * Inner modal content component that accesses theme colors from Modal's ThemeProvider context.
 * Includes workbench header with Lottie animation and progress bars for each processing step.
 */
const ModalContentInner: React.FC<{
  ...
  return (
    <>
      {/* Workbench Header with Animation */}
      <div style={{
        backgroundColor: semanticColors.theme.primary700,
        height: '160px',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <WorkbenchLogo color={semanticColors.theme.primary700} />
              </div>
            </div>
            <div style={{
              ...typography.styles.bodyM,
...
/**
 * Props for BDXProcessingModal component
 */
export interface BDXProcessingModalProps {
...
type ProcessStep = 'uploading' | 'analyzing';
 ...
 *
 * Displays AI-powered BDX data processing with animated progress tracking.
 * Shows 2 sequential steps: uploading and AI analysis.
 * Uses workbench theme regardless of parent page theme.
 *
 * Features:
 ...
 * - Simulated 12-second processing sequence
 * - Disabled Continue button until all steps complete
 */
export const BDXProcessingModal: React.FC<BDXProcessingModalProps> = ({
  isOpen,
  fileName,
  buttonRef,
  onContinue,
  ...
  /**
   * Simulates 2-step processing sequence with progress animations
   * Total duration: ~12 seconds (8s + 4s)
   */
  useEffect(() => {
    if (!isOpen) return;
...
export default BDXProcessingModal;
